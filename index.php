<?php
session_start();
$redirect_path = $appUrl;
if (isset($_SESSION['roles']) && $_SESSION['roles'] == "d") {
   $role = "doctors";
   $redirect_path = "$appUrl/doctor/dashboard.php";
} elseif (isset($_SESSION['roles']) &&  $_SESSION['roles'] == "p") {
   $role = "patients";
   $redirect_path = "$appUrl/patient/dashboard.php";
} elseif (isset($_SESSION['roles']) &&  $_SESSION['roles'] == "a") {
   $role = "admins";
   $redirect_path = "$appUrl/admin/dashboard.php";
} elseif (isset($_SESSION['roles']) &&  $_SESSION['roles'] == "r") {
   $role = "receptionists";
   ...
   <header class="header" data-header>
      <div class="container">
         ...
         if (!isset($_SESSION['user'])) {
            ...
            echo '<a href="' . $redirect_path . '" class="btn has-before title-md">Dashboard</a>';
            echo '<a href="./appointment.php" style="margin-left: 5px;" class="has-before btn title-md">Appointment</a>';
         }
         ?>
      </div>
