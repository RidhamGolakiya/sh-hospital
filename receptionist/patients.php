  ...
  $(document).ready(function() {
    $('#dataTable').DataTable({
      ...
      "columns": [{
        ...
        {
          "render": function(data, type, full, meta) {
            return '<a href="/receptionist/edit-patient.php?id='+ full.id + '" name="edit" title="Edit Patient" value="Edit" class="btn btn-info mx-1 edit_data"><span class="fa fa-pencil"></span></a>' +
